...
export const NewVisit: React.FC = () => {
  ...
  const handleCreateClient = async () => {
    if (!newClientData.name || !newClientData.country) {
      setError('Compila nome e paese del cliente');
      return;
    }
  ...
  const handleCreateCompany = async () => {
    if (!newCompanyData.name || !newCompanyData.country) {
      setError('Compila nome e paese dell\'azienda');
      return;
    }
      ...
      <div className="form-card">
        <form onSubmit={handleSubmit}>
          ...
          {formData.reports.map((report, index) => (
            ...
            >
              <div className="form-group">
                <label>Azienda Rappresentata *</label>
                <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                  <select
                ...
                {showNewCompanyForm && (
                  <div style={{ padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '4px', marginBottom: '10px' }}>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        type="text"
                        placeholder="Es: Tecnologia, Finanza, etc."
              ...
              <div className="form-group">
                <label>Sezione Report *</label>
                <input
                  type="text"
                  placeholder="Es: Analisi, Proposte, Follow-up, etc."
              ...
              <div className="form-group">
                <label>Contenuto Report *</label>
                <textarea
                  placeholder="Descrivi il risultato della visita per questa azienda..."
          ...
          >
            + Aggiungi Altra Azienda
          </button>

          <div className="form-actions">
            <button type="submit" disabled={isSubmitting} className="btn-primary">
              {isSubmitting ? 'Registrando...' : 'Registra Visita'}
            </button>
            <button
              type="button"
