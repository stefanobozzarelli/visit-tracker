...
const MENU_ITEMS: Record<MenuItemKey, { path: string; label: string; icon: string }> = {
  ...
  showrooms: { path: '/showrooms', label: 'Showrooms', icon: '🏬' },
            ...
            <>
              ...
              <div className="sidebar-section">
                ...
                <NavLink
                  ...
                  onClick={closeSidebar}
                >
                  <span className="sidebar-link-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg></span>
                  Statistics
                </NavLink>
                <NavLink
                  to="/settings"
